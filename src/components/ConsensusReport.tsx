  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 animate-slide-up">
      ...
      <div className="space-y-3 mb-4">
        <ScoreBar label="Source Agreement" value={data.sourceAgreement} />
        <ScoreBar label="Signal Agreement" value={data.signalAgreement} />
        <ScoreBar label="Structure Agreement" value={data.structureAgreement} />
        <ScoreBar label="Data Completeness" value={data.dataCompleteness} />
      </div>
