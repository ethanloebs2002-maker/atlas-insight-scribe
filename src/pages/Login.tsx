      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          {magicLinkSent ? (
            <div className="text-center space-y-2 py-4">
              ...
              <p className="text-xs font-mono text-muted-foreground">
                A login link has been sent to <span className="text-foreground">{email}</span>.
                Check your inbox.
              </p>
              <Button
                variant="ghost"
          ...
          <p className="text-[10px] font-mono text-muted-foreground text-center">
            After first login, an admin must activate your account before you can access the system.
          </p>
        </CardContent>
      </Card>
    </div>
